...
final <- ggplot(data = salary_industry)+
  ...
  geom_label(aes(x = -0.5, y = index_ind, label = industry), hjust = 1, color = "grey90", label.size = 0, fill = "grey30", size = 4.5, family = "roboto condensed") +
  ...
  theme_void() +
  theme(plot.background = element_rect(fill = "grey30", color = NA),
