...
final <- ar_wide %>%
  ...
  # cost plot
  geom_text(data = cost, aes(x = 330, y = posy - offset, label = dollar(total_cost_2019, prefix = "£")), hjust = 1.1) +
  geom_text(data = cost, aes(x = 380, y = posy + offset, label = dollar(total_cost_2020, prefix = "£"), color = sign2020), hjust = -0.1, fontface = "bold") +
  ...
  annotate("text", x = 350, y = 6.1, label = text2, hjust = 0.5, vjust = 0) +
  annotate("text", x = 320, y = 5.8, label = "2019", hjust = 1, vjust = 0) +
  annotate("text", x = 385, y = 5.8, label = "2020", hjust = 0, vjust = 0) +
